...
describe('PasswordInputComponent', () => {
  ...
  const defaultParams = { control: new FormControl(), label: 'password', toggleAriaLabel: 'toggle button', errorMap: { required: 'required' } };
  const createComponent = createComponentFactory({ component: PasswordInputComponent });
